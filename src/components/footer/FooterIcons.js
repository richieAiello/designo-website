...
const youtube = 
  <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
    <path 
      className="footer__icon-fill" 
      d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 
      0 12 0zm4.441 16.892c-2.102.144-6.784.144-8.883 0C5.282 16.736 5.017 
      15.622 5 12c.017-3.629.285-4.736 2.558-4.892 2.099-.144 6.782-.144 
      8.883 0C18.718 7.264 18.982 8.378 19 12c-.018 3.629-.285 4.736-2.559 
      4.892zM10 9.658l4.917 2.338L10 14.342V9.658z" 
      fill="#E7816B" fillRule="nonzero"
    />
  </svg>;
...
const twitter =
  <svg width="24" height="20" xmlns="http://www.w3.org/2000/svg">
    <path 
      ...
      4.89a4.935 4.935 0 01-2.224.084 4.928 4.928 0 004.6 3.419A9.9 9.9 0 010 
      17.54a13.94 13.94 0 007.548 2.212c9.142 0 14.307-7.721 
...
const pinterest = 
  <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
    <path 
      ...
      1.031.397 2.138.893 2.738a.36.36 0 01.083.345l-.333 
      ...
      24c6.627 0 12-5.373 12-12 0-6.628-5.373-12-12-12z" 
      fill="#E7816B" fillRule="nonzero"
    />
  </svg>;
...
const instagram = 
  <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
    <path 
      ...
      0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 
      0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 
